...
func (_m *ProductRepository) GetAll(ctx context.Context, query domain.ProductQuery) ([]*domain.Product, int64, error) {
	...
	var r1 int64
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.ProductQuery) ([]*domain.Product, int64, error)); ok {
		return rf(ctx, query)
	}
	if rf, ok := ret.Get(0).(func(context.Context, domain.ProductQuery) []*domain.Product); ok {
		r0 = rf(ctx, query)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, domain.ProductQuery) int64); ok {
		r1 = rf(ctx, query)
	} else {
		r1 = ret.Get(1).(int64)
	}

	if rf, ok := ret.Get(2).(func(context.Context, domain.ProductQuery) error); ok {
		r2 = rf(ctx, query)
	} else {
		r2 = ret.Error(2)
	}
